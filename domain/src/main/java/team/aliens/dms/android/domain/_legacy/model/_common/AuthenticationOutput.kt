...
data class AuthenticationOutput(
    ...
    val features: team.aliens.dms.android.domain._legacy.model._common.AuthenticationOutput.Features,
) {
...
fun team.aliens.dms.android.domain._legacy.model._common.AuthenticationOutput.Features.toModel(): Features {
    return Features(
