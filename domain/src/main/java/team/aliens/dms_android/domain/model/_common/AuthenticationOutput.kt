...
data class AuthenticationOutput(
    ...
    val features: team.aliens.dms_android.domain.model._common.AuthenticationOutput.Features,
) {
...
fun team.aliens.dms_android.domain.model._common.AuthenticationOutput.Features.toModel(): Features {
    return Features(
