package com.example.feature_data.util

import com.example.feature_domain.exception.BadRequestException
import com.example.feature_domain.exception.ConflictException
import com.example.feature_domain.exception.ForbiddenException
import com.example.feature_domain.exception.NeedLoginException
import com.example.feature_domain.exception.NoInternetException
import com.example.feature_domain.exception.NotFoundException
import com.example.feature_domain.exception.ServerException
import com.example.feature_domain.exception.TimeoutException
import com.example.feature_domain.exception.TooManyRequestException
import com.example.feature_domain.exception.UnauthorizedException
import com.example.feature_domain.exception.UnknownException
